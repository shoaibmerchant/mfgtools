...
#[no_mangle]
#[used]
#[export_name = "?g_verbose@@3HA"] // probably because we are linking with a release build
pub static mut g_verbose: ::std::os::raw::c_int = 0;


#[no_mangle]
#[used]
#[export_name = "?g_bmap_mode@@3W4bmap_mode@@A"] // probably because we are linking with a release build
